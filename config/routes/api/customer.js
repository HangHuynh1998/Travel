...
// router.get("/detail/applied-tours", jwtAuth, hasRole('customer'), customerCtrl.getA);
// APPLICATIONS
// router.get("/detail/my-applications", jwtAuth, hasRole('customer'), customerCtrl.getSeekerApplications);
